...
export default function DestinationModal() {
  ...
  return (
    ...
    >
      <div
        className="bg-white text-slate-900 w-full max-w-[1000px] rounded-[2.5rem] relative shadow-[0_20px_60px_rgba(0,0,0,0.3)] transform translate-y-12 transition-all duration-300 max-h-[90vh] overflow-y-auto custom-scrollbar animate-scaleIn"
